  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-transparent sm:bg-black/40 p-4 font-sans relative">
      <PitchModal 
        ...
        adn="Utilité pure (compréhension du tournoi) et projection émotionnelle dans les scénarios de la compétition."
        why="Générer de l'engagement naturel et donner envie de parier sur un scénario précis plutôt que sur un match isolé."
        swot={{
          s: ["Forte valeur d'usage pour le lecteur", "Extrêmement visuel", "Lien évident avec le pari"],
          w: ["Dépend de la connaissance des groupes par l'utilisateur", "Cote globale parfois difficile à appréhender"],
          o: ["Partageable sur les réseaux sociaux (mon scénario idéal)", "Intégration parfaite dans les pages 'Calendrier' des médias"],
          t: ["Lassitude si les scénarios de groupes perdent en enjeu (3ème match)"]
        }}
      />
